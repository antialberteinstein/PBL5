...
def _post_json(path: str, payload: Dict[str, Any]) -> str:
...
@app.get("/")
def index():
    return render_template_string(HTML_TEMPLATE, api_base=API_BASE_URL, result=None)
...
def register():
    ...
    return render_template_string(HTML_TEMPLATE, api_base=API_BASE_URL, result=result)
